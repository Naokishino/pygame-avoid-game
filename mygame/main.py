...
# 画像の読み込み
player_image = pygame.image.load("C:/Users/篠原尚希/mygame/images/player.jpg").convert_alpha()
enemy_image = pygame.image.load("C:/Users/篠原尚希/mygame/images/enemy.jpg").convert_alpha()
...
def display_tutorial():
    ...
    # instructions = font.render("左右十字キーを使ってプレイします.", True, BLACK)
